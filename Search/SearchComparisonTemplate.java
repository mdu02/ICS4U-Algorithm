...
public class SearchComparisonTemplate{
    public static void main(String[] args){
        ...
        int item = 0;             //worst case scenario is to search for the last item
        int index = 0;
...
//------------------------------------------------------------------------------    
    ...
    public static int recursiveBinarySearch(int item, ArrayList<Integer> items, int left, int right){
        ...
        if (items.get(mid) == item){
            ...
            return recursiveBinarySearch(item, items, left, mid-1);
        } else {
            return recursiveBinarySearch(item, items, mid+1, right);
        }
    }    
}
